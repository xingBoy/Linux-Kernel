...
static const struct display_panel disp_panel = {
	...
	32,  //32,
	8,  //32,
	COLOR_ACTIVE,/*COLOR_PASSIVE COLOR_ACTIVE,*/
};
...
struct da8xx_lcdc_platform_data LS035Y8DX02A_pdata= {
	.manu_name		= "ThreeFive",
	.controller_data	= &lcd_cfg,
	.type			= "TLS035Y8DX02A",
};
...
static void mii1_init(int evm_id, int profile)
{
	...
	//pr_info("danny --------  mii_init success\n");
	return;
}
 ...
 *
	{
		.modalias      = "m25p80",
		.platform_data = NULL,//&am335x_spi_flash,
		.irq           = -1,
...
static struct i2c_board_info am335x_i2c2_boardinfo[] = {
	{
		I2C_BOARD_INFO("t110_co2_module", 0x31),
	},
	{
...
static struct evm_dev_cfg gen_purp_evm_dev_cfg[] = {
	...
	{usb1_init,	DEV_ON_DGHTR_BRD, PROFILE_ALL},
	...
	{mmc2_wl12xx_init,	DEV_ON_DGHTR_BRD, (PROFILE_0 | PROFILE_3 |
								PROFILE_5)},
	{mmc0_init,	DEV_ON_BASEBOARD, (PROFILE_ALL & ~PROFILE_5)},
	{mmc0_no_cd_init,	DEV_ON_BASEBOARD, PROFILE_5},
	{spi0_init,	DEV_ON_DGHTR_BRD, PROFILE_2},
	{uart1_wl12xx_init,	DEV_ON_DGHTR_BRD, (PROFILE_0 | PROFILE_3 |
								PROFILE_5)},
	{wl12xx_init,	DEV_ON_DGHTR_BRD, (PROFILE_0 | PROFILE_3 | PROFILE_5)},
...
static void am335x_evm_setup(struct memory_accessor *mem_acc, void *context)
{
	...
	if (ret != sizeof(config)) {
		...
		config.header = AM335X_EEPROM_HEADER; //header
		memcpy(config.name ,"A335",4); //AM335x evm
		memcpy(config.opt ,"SKU#01",6); //general purpose board

		memcpy(config.version ,"1.5A",4); //GEN_PURP_EVM 
...
#define PMIC_IRQ_GPIO       GPIO_TO_PIN(1, 24)
