...
static void ecm_5206_cpsw_init(int evm_id, int profile)
{
...
static struct evm_dev_cfg ecm_5206_dev_cfg[] = {
	{mmc0_init,	    DEV_ON_BASEBOARD, PROFILE_ALL},
	{evm_nand_init, DEV_ON_BASEBOARD, PROFILE_ALL},
	{ecm_5206_cpsw_init, DEV_ON_BASEBOARD, PROFILE_ALL},
...
static void setup_ecm_5206(void)
{
	pr_info("The board is a ecm_5206.\n");

	/*which doesn't have Write Protect pin LAN8710A_PHY_ID */
	am335x_mmc[0].gpio_wp = -EINVAL;

	_configure_device(EVM_SK, ecm_5206_dev_cfg, PROFILE_NONE);
}
...
MACHINE_START(APLEX_ECM_5206L, "aplex_ECM_5206L")
