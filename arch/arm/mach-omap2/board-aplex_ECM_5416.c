...
static struct pinmux_config wk24xx_pin_mux[] = {
    ...
    {"gpmc_ad13.gpio1_13",  OMAP_MUX_MODE7 },                           /* R12   wk2414 irq */
    {"gpmc_ad14.gpio1_14",  OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT_PULLUP}, /* V13   wk24xx reset */
    {"gpmc_ad15.gpio1_15",  OMAP_MUX_MODE7 },                           /* U13   wk24xx irq */
	{NULL, 0},
};
...
/* led1 led2 led3 */
static void spi_wk24xx_init(int evm_id, int profile)
{
	setup_pin_mux(wk24xx_pin_mux);
...
static struct evm_dev_cfg ECM_5412_dev_cfg[] = {
	...
	{spi_wk24xx_init,   DEV_ON_BASEBOARD, PROFILE_ALL},
    {NULL, 0, 0},
};
...
MACHINE_START(APLEX_ECM_5416, "aplex_ECM_5416")
