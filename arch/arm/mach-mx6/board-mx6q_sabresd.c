...
#define SABRESD_CSI0_RST	IMX_GPIO_NR(1, 26)
#define SABRESD_MIPICSI_PWN	IMX_GPIO_NR(1, 8)
// #define SABRESD_MIPICSI_RST	IMX_GPIO_NR(1, 20)
#define SABRESD_MIPICSI_RST	IMX_GPIO_NR(1, 7)
#define SABRESD_CHARGE_UOK_B	IMX_GPIO_NR(1, 27)

#define SABRESD_SD1_CD		IMX_GPIO_NR(6, 10)
...
// BT
#define SABRESD_BT_RESET	IMX_GPIO_NR(2, 7)

#define SABRESD_GPS_PWR_EN		IMX_GPIO_NR(3, 0)
#define SABRESD_GPS_RST		IMX_GPIO_NR(2, 28)

#define SABRESD_ALS_INT		IMX_GPIO_NR(3, 9)
// #define SABRESD_eCOMPASS_INT	IMX_GPIO_NR(3, 20)
...
#define SABRESD_ECSPI1_CS1	IMX_GPIO_NR(4, 10)

#define SABRESD_ECSPI2_CS0	IMX_GPIO_NR(2, 26)
#define SABRESD_ECSPI2_CS1 	IMX_GPIO_NR(2, 27)

#define SABRESD_ECSPI4_CS0 	IMX_GPIO_NR(3, 20)
#define SABRESD_ECSPI4_CS1 	IMX_GPIO_NR(5, 2)
...
// #define SABRESD_DISP_RST_B	IMX_GPIO_NR(5, 28)
// #define SABRESD_DISP_RST_B	IMX_GPIO_NR(1, 23)
// #define SABRESD_DISP_RST_B	IMX_GPIO_NR(1, 16)
...
#define SABRESD_GOODIX_TS_INT	IMX_GPIO_NR(1, 17)
#define SABRESD_FEC_PHY_RESET	IMX_GPIO_NR(1, 25)
...
//#define SABRESD_I2C4_SDA_GPIO    IMX_GPIO_NR(4, 15)
//#define SABRESD_I2C4_SCL_GPIO    IMX_GPIO_NR(4, 14)
#define SABRESD_WL_HOST_WAKE     IMX_GPIO_NR(1, 7)
#define SABRESD_WL_RESET          IMX_GPIO_NR(2, 5)

#define SABREAUTO_PMIC_INT      IMX_GPIO_NR(7, 13)

#define RK30SDK_WIFI_GPIO_WIFI_INT_B SABRESD_WL_HOST_WAKE
#define RK30SDK_WIFI_GPIO_WIFI_INT_B_ENABLE_VALUE GPIO_HIGH

// Tony 2016-11-21
#define SABRESD_AR1020_INT      IMX_GPIO_NR(6, 7)

#define SABRESD_RGB_BLK_EN      IMX_GPIO_NR(6, 15)
// WIFI
#define WIFI_CHIP_EN            IMX_GPIO_NR(5, 19)
#define BT_HOST_WAKE            IMX_GPIO_NR(5, 18)
#define WIFI_SDIO_WAKE          IMX_GPIO_NR(6, 2)
#define WIFI_SDIO_RESET         IMX_GPIO_NR(6, 3)
#define BT_W_DISABL2            IMX_GPIO_NR(5, 20)
#define UART5_WAKE_N            IMX_GPIO_NR(5, 21)
...
static int mx6q_sabresd_spi4_cs[] = {
	SABRESD_ECSPI4_CS0,
	SABRESD_ECSPI4_CS1,
};

static const struct spi_imx_master mx6q_sabresd_spi4_data __initconst = {
	.chipselect     = mx6q_sabresd_spi4_cs,
	.num_chipselect = ARRAY_SIZE(mx6q_sabresd_spi4_cs),
};
...
static struct spi_board_info imx6_sabresd_spi_nor_device[] __initdata = {
	...
	{
		.modalias = "ar1020-spi",
		.max_speed_hz = 32000, /* max spi clock (SCK) speed in HZ */
		.bus_num = 1,
		.chip_select = 0,
		.mode = SPI_MODE_1,
...
static struct i2c_board_info mxc_i2c0_board_info[] __initdata = {
	/**
	 * zengjf 2015-8-13 add wm8962 to i2c0 bus
	 */
	{
...
static struct gpio_keys_button new_sabresd_buttons[] = {
	...
	//GPIO_BUTTON(SABRESD_POWER_OFF, KEY_SCREENLOCK, 1, "power-key", 1, 1),
//	GPIO_BUTTON(SABRESD_POWER_OFF, KEY_SLEEP, 1, "power-key", 1, 1),
	//GPIO_BUTTON(SABRESD_POWER_OFF, KEY_POWER, 1, "power-key", 1, 1),
	//GPIO_BUTTON(SABRESD_POWER_OFF, KEY_POWER, 0, "power-key", 0, 1),
};
...
static struct platform_device sabresd_button_device = {
	...
	.num_resources  = 0,
    .dev        = {
        .platform_data = &new_sabresd_button_data,
    }
};
...
static struct platform_pwm_backlight_data mx6_sabresd_pwm0_backlight_data = {
	.pwm_id = 0,
	.max_brightness = 248,
	.dft_brightness = 128,
 	/**
 	 * zengjf 2015-7-25 modify to 200Hz for toshiba 12.1'' display backlight
 	 */
 	//.pwm_period_ns = 5000000,		// 12.1''
 	//.pwm_period_ns = 50000,		// normal
	.pwm_period_ns = 50000,
};
static struct platform_pwm_backlight_data mx6_sabresd_pwm1_backlight_data = {
	.pwm_id = 1,
	.max_brightness = 248,
	.dft_brightness = 128,
 	/**
...
static void __init uart5_init(void)
{
	...
	imx6q_add_imx_uart(2, &mx6q_sd_uart5_data);
}
*/
...
static void __init mx6_sabresd_board_init(void)
{
	...
	if (cpu_is_mx6q())
		printk("<danny debug> this board cpu is mx6q\n");
	if (cpu_is_mx6dl()) 
		printk("<danny debug> this board cpu is mx6dl\n");
...
//	imx6q_add_mipi_csi2(&mipi_csi2_pdata);
	...
	/**
	 * zengjf 2015-8-5 del internal rtc
	 */
...
/*	ret = gpio_request(SABRESD_PFUZE_INT, "pFUZE-int");
	...
	imx6q_add_ecspi(3, &mx6q_sabresd_spi4_data);
	spi_device_init();
	...
	//printk("<danny debug> add net fec device\n");
#if 0
#ifdef CONFIG_MX6_ENET_IRQ_TO_GPIO
	...
	*/
	 ...
	 * 
	 * zengjf 2015-10-8 this has down in uboot 
	 */
    ...
    // LCD
    gpio_request(SABRESD_RGB_BLK_EN, "lcd-en");
	gpio_direction_output(SABRESD_RGB_BLK_EN, 1);
    gpio_free(SABRESD_RGB_BLK_EN);

    // GPS reset, active low
    gpio_request(SABRESD_GPS_RST, "gps rst");
	gpio_direction_output(SABRESD_GPS_RST, 1);
    gpio_free(SABRESD_GPS_RST);

    gpio_request(SABRESD_GPS_PWR_EN, "gps power");
	gpio_direction_output(SABRESD_GPS_PWR_EN, 1);
    gpio_free(SABRESD_GPS_PWR_EN);

	imx6q_add_mxc_pwm(0);
	imx6q_add_mxc_pwm(1);
//	imx6q_add_mxc_pwm(2);
	imx6q_add_mxc_pwm(3);
	imx6q_add_mxc_pwm_backlight(0, &mx6_sabresd_pwm0_backlight_data);
	imx6q_add_mxc_pwm_backlight(1, &mx6_sabresd_pwm1_backlight_data);
...
/*	gpio_request(SABRESD_eCOMPASS_INT, "ecompass-int");
	gpio_direction_input(SABRESD_eCOMPASS_INT);	nan */
...
/*		gpio_request(SABRESD_ELAN_INT, "elan-interrupt");
		...
		//gpio_request(SABRESD_FT5X06_INT, "ft5x06-interrupt");
		...
		gpio_direction_output(SABRESD_WL_RESET, 0);
...
//		gpio_direction_output(SABRESD_FT5X06_RST, 1);
    ...
    gpio_request(WIFI_CHIP_EN, "wifi bluthooth chip enable");
    gpio_direction_output(WIFI_CHIP_EN, 1);
    gpio_free(WIFI_CHIP_EN);

    gpio_request(BT_HOST_WAKE, "bluethooth wake");
    gpio_direction_output(BT_HOST_WAKE, 1);
    gpio_free(BT_HOST_WAKE);

    gpio_request(WIFI_SDIO_WAKE, "wifi sdio wake");
    gpio_direction_output(WIFI_SDIO_WAKE, 1);
    gpio_free(WIFI_SDIO_WAKE);

    gpio_request(WIFI_SDIO_RESET, "wifi sdio reset");
    gpio_direction_output(WIFI_SDIO_RESET, 1);
    gpio_free(WIFI_SDIO_RESET);

    gpio_request(BT_W_DISABL2, "bluethooth ");
    gpio_direction_output(BT_W_DISABL2, 1);
    gpio_free(BT_W_DISABL2);

    gpio_request(UART5_WAKE_N, "bluethooth ");
    gpio_direction_output(UART5_WAKE_N, 0);
    gpio_free(UART5_WAKE_N);
