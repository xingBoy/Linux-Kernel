...
static iomux_v3_cfg_t mx6dl_sabresd_pads[] = {
	...
	MX6DL_PAD_EIM_RW__GPIO_2_26,    // CS0
	MX6DL_PAD_EIM_LBA__GPIO_2_27,   // CS1
...
//    MX6DL_PAD_ENET_CRS_DV__GPIO_1_25,
	...
	//MX6DL_PAD_DI0_PIN15__LCDIF_ENABLE,		/* DE */
	MX6DL_PAD_DI0_PIN2__IPU1_DI0_PIN2,		/* HSync */
	//MX6DL_PAD_DI0_PIN2__LCDIF_HSYNC,		/* HSync */
	MX6DL_PAD_DI0_PIN3__IPU1_DI0_PIN3,		/* VSync */
	//MX6DL_PAD_DI0_PIN3__LCDIF_VSYNC,		/* VSync */
//	MX6DL_PAD_DI0_PIN4__GPIO_4_20,		/* Contrast */
    ...
    MX6DL_PAD_NANDF_CS1__GPIO_6_14,     // LCD_CS
	...
	MX6DL_PAD_EIM_D30__GPIO_3_30,       // CHARGE_INT_B
	/*USB_H1 PWR EN*/
...
//	MX6DL_PAD_NANDF_WP_B__GPIO_6_9,		//PCIE_WAKE
    ...
    // volume
	MX6DL_PAD_GPIO_4__GPIO_1_4,     // VOLUME_UP
	MX6DL_PAD_GPIO_5__GPIO_1_5,     // VOLUME_DN
	...
	//GPIO 4 for input and 4 for output
	//MX6DL_PAD_SD2_DAT0__GPIO_1_15,	//GPIO In
	//MX6DL_PAD_SD2_DAT1__GPIO_1_14,
	//MX6DL_PAD_SD2_DAT2__GPIO_1_13,
	//MX6DL_PAD_SD2_DAT3__GPIO_1_12,
	...
	// MX6DL_PAD_GPIO_7__GPIO_1_7,
	// MX6DL_PAD_SD1_DAT1__GPIO_1_17,		//touch interupt
...
//	MX6DL_PAD_ENET_REF_CLK__GPIO_1_23,
    ...
    MX6DL_PAD_EIM_EB1__GPIO_2_29,       // GPIO0
    MX6DL_PAD_EIM_DA1__GPIO_3_1,        // GPIO1
    MX6DL_PAD_EIM_DA2__GPIO_3_2,        // GPIO2
    MX6DL_PAD_EIM_DA3__GPIO_3_3,        // GPIO3
    MX6DL_PAD_EIM_DA4__GPIO_3_4,        // GPIO4
    MX6DL_PAD_EIM_DA5__GPIO_3_5,        // GPIO5
    MX6DL_PAD_EIM_DA6__GPIO_3_6,        // GPIO6
    MX6DL_PAD_EIM_DA7__GPIO_3_7,        // GPIO7

    // matrix keypad
    /*
    MX6DL_PAD_KEY_COL0__KPP_COL_0,
    MX6DL_PAD_KEY_ROW0__KPP_ROW_0,
    MX6DL_PAD_KEY_COL1__KPP_COL_1,
    MX6DL_PAD_KEY_ROW1__KPP_ROW_1,
    MX6DL_PAD_KEY_COL2__KPP_COL_2,
    MX6DL_PAD_KEY_ROW2__KPP_ROW_2,
    MX6DL_PAD_KEY_COL3__KPP_COL_3,
    MX6DL_PAD_KEY_ROW3__KPP_ROW_3,
    */
    ...
    // WIFI, BLUETOOTH
    MX6DL_PAD_NANDF_D2__GPIO_2_2,   // CHIP_EN
    MX6DL_PAD_NANDF_D3__GPIO_2_3,   // BT_HOST_WAKE
    MX6DL_PAD_NANDF_D4__GPIO_2_4,   // UART3_WAKE_N
    MX6DL_PAD_NANDF_D5__GPIO_2_5,   // SDIO_WAKE
    MX6DL_PAD_NANDF_D6__GPIO_2_6,   // SDIO_RESET
    MX6DL_PAD_NANDF_D7__GPIO_2_7,   // W_DISABL2

    // AD7606
    MX6DL_PAD_ENET_MDC__GPIO_1_31,  // CONVST
    MX6DL_PAD_NANDF_RB0__GPIO_6_10, // RESET
    MX6DL_PAD_NANDF_ALE__GPIO_6_8,  // DS0
    MX6DL_PAD_NANDF_CLE__GPIO_6_7,  // DS1
    MX6DL_PAD_NANDF_WP_B__GPIO_6_9, // DS2
    MX6DL_PAD_ENET_REF_CLK__GPIO_1_23, // FRST
    MX6DL_PAD_ENET_MDIO__GPIO_1_22, // STBY
    MX6DL_PAD_ENET_CRS_DV__GPIO_1_25, // BUSY

    MX6DL_PAD_EIM_D19__GPIO_3_19, // SENSOR_PWR_EN
