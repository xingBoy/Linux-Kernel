...
make -j2 zImage imx6dl-sabresd.dtb
#make -j2 dtbs
...
cp arch/arm/boot/zImage /mnt/hgfs/share/7112/IMX6_L4.1.15_2.0.0_MFG-TOOL/Profiles/Linux/OS\ Firmware/files/zImage
cp arch/arm/boot/dts/imx6dl-sabresd.dtb /mnt/hgfs/share/7112/IMX6_L4.1.15_2.0.0_MFG-TOOL/Profiles/Linux/OS\ Firmware/files/zImage-imx6dl-sabresd.dtb
sync
sleep 1
echo "copy zImage"
