#ifndef	 _SERIAL_WK2124B_H_
#define  _SERIAL_WK2124B_H_
...
#define 	SERIAL_WK2124B_MAJOR	    200
#define 	CALLOUT_WK2124B_MAJOR		201
...
#define 	IRQ_WK2124B		        OMAP_GPIO_IRQ(GPIO_TO_PIN(0, 27))
