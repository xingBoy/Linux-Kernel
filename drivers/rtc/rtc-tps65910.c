...
extern int regmap_bulk_write(struct regmap *map, unsigned int reg, const void *val,
		     size_t val_count);
...
//	printk("danny debug ------- rtc-tps65910   read time!\n");
	return ret;
}
...
static int tps65910_rtc_set_time(struct device *dev, struct rtc_time *tm)
{
	...
	//printk("danny debug ------- rtc-tps65910   set time!\n");
...
static int __devinit tps65910_rtc_probe(struct platform_device *pdev)
{
	...
	//printk("danny debug ---- rtc-tps65910 prob! \n");
