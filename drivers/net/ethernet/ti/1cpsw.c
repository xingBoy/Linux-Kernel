...
static irqreturn_t cpsw_interrupt(int irq, void *dev_id)
{
    ...
    printk(KERN_ALERT "1Debug!!!!!!!!!!\n");
    printk(KERN_ALERT "1This is cpsw_interrupte position!!!!!!!!!!!!!!!!!!!!!!\n");
	...
	printk(KERN_ALERT "2Debug!!!!!!!!!!\n");
    printk(KERN_ALERT "2This is cpsw_interrupte position!!!!!!!!!!!!!!!!!!!!\n");
    } 
    else {
		priv = cpsw_get_slave_priv(priv, 1);
        
        printk(KERN_ALERT "3Debug!!!!!!!!!!\n");
        printk(KERN_ALERT "3This is cpsw_interrupte position!!!!!!!!!!!!!!!!!!!!!!\n");
		...
		if (likely(priv) && likely(netif_running(priv->ndev))) {
            ...
            printk(KERN_ALERT "4Debug!!!!!!!!!!\n");
            printk(KERN_ALERT "4This is cpsw_interrupte position!!!!!!!!!!!!!!!!!!!!!!\n");
		}
	}
			      ...
			      struct cpsw_priv *priv, bool *link)
{
	...
	if (phy->link) {
        ...
        /*    
        printk(KERN_ALERT "1Debug!!!!!!!!!!\n");
            printk(KERN_ALERT "1This is 10M!!!!!!!!!!!!!!!!!!!!!\n");
*/
        ...
        /*
           printk(KERN_ALERT "1Debug!!!!!!!!!!\n");
           printk(KERN_ALERT "1This is 1000M!!!!!!!!!!!!!!!!!!!!!\n");
*/
		if (phy->speed == 100)
            mac_control |= BIT(15);
      /*
        printk(KERN_ALERT "1Debug!!!!!!!!!!\n");
        printk(KERN_ALERT "1This is 100M!!!!!!!!!!!!!!!!!!!!!\n");
*/
		if (phy->duplex)
