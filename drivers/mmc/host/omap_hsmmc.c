...
/**
  * zengjf 2015-9-28 add for sdDetect
  */
struct omap_hsmmc_host *sdDetect;
...
{
    //printk("zengjf check hsmmc detect.");
...
static int __init omap_hsmmc_probe(struct platform_device *pdev)
{
    ...
    /**
      * zengjf 2015-9-28 add for sdDetect
      */
    //printk("zengjf mmc_slot(host).card_detect_irq: %d.", mmc_slot(host).card_detect_irq);
    sdDetect = host;
