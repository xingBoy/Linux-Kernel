...
#define CONFIG_XDMA_EVENT_INTR1_offset			0x9B4
#define CONFIG_XDMA_GPMC_A6_offset   			0x8B8
#define GTP_RST_PORT    GPIO_TO_PIN(1,22) 
#define GTP_INT_PORT    GPIO_TO_PIN(0,20)
#define GTP_INT_IRQ     gpio_to_irq(GTP_INT_PORT)


#define GTP_GPIO_CFG_PINMUX()          do{\ 
											void __iomem * base = ioremap(Control_Module_address , 0x1FFF); \
										     __raw_writel(0x2F,(base + CONFIG_XDMA_EVENT_INTR1_offset     ));\
										     __raw_writel(0x2F,(base + CONFIG_XDMA_GPMC_A6_offset));\
                                        }while(0)
