...
//#define RESOLUTION_1366X768_15_6_INCH
//#define RESOLUTION_640X480_5_7_INCH
//#define RESOLUTION_1366X768_11_6_INCH
//#define RESOLUTION_1024X768_12_1_INCH
//#define RESOLUTION_1280X800_10_1_INCH
#define RESOLUTION_1024X600_10_1_INCH
//#define RESOLUTION_800X600_8_INCH
//#define RESOLUTION_1024X600_8_INCH
//#define RESOLUTION_800X480_7_INCH
...
#ifdef RESOLUTION_1366X768_15_6_INCH
	/**
     	* zengjf 2015-7-29 add to 15.6'' display for Inputech
     	*/
    	{
        // 1366x768 @ 60 Hz
        //"LDB-XGA", 60, 1366, 768, 13255, 92, 92, 18, 18, 10, 2,
        "LDB-XGA", 60, 1366, 768, 13255, 92, 92, 18, 18, 10, 2,
        0,
        FB_VMODE_NONINTERLACED,
        FB_MODE_IS_DETAILED,
...
#ifdef RESOLUTION_640X480_5_7_INCH
	/**
     * zengjf 2015-8-3 add to 5.7'' display for toshiba
     */
    {
        // 640x480 @ 40 Hz
        "LDB-XGA",
    	//40, 640, 480, 17037, 14, 16, 32, 10, 30, 3,
    	//40, 640, 480, 37037, 114, 16, 32, 10, 30, 3,
    	//40, 640, 480, 15385, 114, 16, 32, 10, 30, 3,
		40, 640, 480, 15385, 220, 40, 21, 7, 60, 10,
        0,
        FB_VMODE_NONINTERLACED,
        FB_MODE_IS_DETAILED,
    },
...
#ifdef RESOLUTION_1366X768_11_6_INCH
	/**
     * zengjf 2015-7-29 add to 11.6'' display for Inputec
     */
    {
        // 1366x768 @ 60 Hz
        "LDB-XGA",
		60, 1366, 768, 13825, 84, 36, 14, 3, 40, 5,
        0,
        FB_VMODE_NONINTERLACED,
        FB_MODE_IS_DETAILED,
    },
...
#ifdef RESOLUTION_1024X768_12_1_INCH
	/**
     * zengjf 2015-7-24 add to 12.1'' display for toshiba
     */
    {
        // 1024x768 @ 60 Hz
        "LDB-XGA", 60, 1024, 768, 17818,
		84, 36,
		14, 3, 
		40, 5,
        0,
...
#ifdef RESOLUTION_1280X800_10_1_INCH
	/**
     * zengjf 2015-7-22 add to 10.1'' display for toshiba
     */
    {
        // 1280x800 @ 60 Hz
        "LDB-XGA", 60, 1280, 800, 13966,
        110, 53,
        8, 8,
        7, 7,
        0,
...
#ifdef RESOLUTION_1024X600_10_1_INCH
	/**
     * zengjf 2015-7-22 add to 10.1'' display for toshiba
     */
...
#ifdef RESOLUTION_800X600_8_INCH
    {
        /*
        // 800X600 @ 60 Hz
        "LDB-XGA", 60, 800, 600, 30998,
        100, 50,
        20, 20,
        50, 8,
        0,
        ...
        */
        ...
        // 800X600 @ 60 Hz
		//zengjf 2015-7-22 add to 8" display for 7112
        "LDB-XGA", 60, 800, 600, 30998,
        112, 88,
        21, 39,
        48, 3,
...
#ifdef RESOLUTION_1024X600_8_INCH
	{
...
#ifdef RESOLUTION_800X480_7_INCH
	/**
	 * zhaoyc 2015-6-18 add to 7'' display for parker
	 */
    {
        // 800x480 @ 60 Hz , pixel clk @ 32.6MHz 
		"LDB-XGA", 60, 800, 480,30998,
		39, 39,
		29, 13,
		47, 2,
		0,
